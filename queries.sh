...
echo "$($PSQL "SELECT name FROM teams FULL JOIN games ON teams.team_id = ANY(ARRAY[games.winner_id, games.opponent_id]) WHERE year = 2014 AND round = 'Eighth-Final' ORDER BY name")"
